...
function Top() {
  ...
  const [html, setHtml] = useState(
    "<h1>test</h1><script>alert('sss')</script>"
  );
      ...
      <form id="form1" onSubmit={handleSubmit}>
        ...
        <div>
          ...
          {state.check === 0 ? (
            <div>
              <label>
                left <input type="radio" name="check" value="0" checked />
              </label>
              <label>
                {' '}
                right <input type="radio" name="check" value="1" />
              </label>
            </div>
          ) : (
            <div>
              <label>
                left <input type="radio" name="check" value="0" />
              </label>
              <label>
                {' '}
                right <input type="radio" name="check" value="1" checked />
              </label>
            </div>
          )}
        </div>
